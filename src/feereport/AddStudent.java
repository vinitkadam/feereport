...
//				int due=Integer.parseInt(textField_5.getText());
				...
				Student s=new Student(name,email,course,fee,paid,address,city,state,country,contactno);
				if(!(fee < paid)){
				...
				if(status>0){
					...
					JOptionPane.showMessageDialog(AddStudent.this,"Sorry, Unable to add student!");
                                    ...
                                    JOptionPane.showMessageDialog(AddStudent.this, "Please check the amount paid by student \n Amount paid connot be greater than total fee");
                                } 
