...
//				int due=Integer.parseInt(textField_5.getText());
				...
				if(status>0){
					...
					JOptionPane.showMessageDialog(EditStudent.this,"Sorry, Unable to add student!");
                                    ...
                                    JOptionPane.showMessageDialog(EditStudent.this, "Please check the amount paid by student \n Amount paid connot be greater than total fee");
                                }
			}
		});
		...
		btnLoadRecord.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				textField_4.setText(String.valueOf(s.getPaid()));
                                lblDueFee.setText(String.valueOf(s.getDue()));
				...
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING, false)
                                                        .addComponent(lblDueFee, GroupLayout.PREFERRED_SIZE, 192, GroupLayout.PREFERRED_SIZE)
		...
		gl_contentPane.setVerticalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
						.addComponent(lblDue)
						.addComponent(lblDueFee, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
